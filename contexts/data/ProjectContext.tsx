...
import { 
  StoryProjectMetadata, ChapterLog, SyncState, ProjectAction, 
  MetaAction, ChapterAction, SyncAction 
} from '../../types';
...
export const useProjectDispatchContext = () => {
  const context = useContext(ProjectDispatchContext);
  if (!context) throw new Error('useProjectDispatchContext must be used within a ProjectDispatchContext.Provider');
  return context;
};
