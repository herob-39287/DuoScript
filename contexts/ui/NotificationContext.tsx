...
export const NotificationDispatchContext = createContext<NotificationDispatch | undefined>(
  undefined,
);
...
export const useNotifications = () => {
  ...
  if (!context)
    throw new Error('useNotifications must be used within a NotificationStateContext.Provider');
  return context;
};
...
export const useNotificationDispatch = () => {
  ...
  if (!context)
    throw new Error(
      'useNotificationDispatch must be used within a NotificationDispatchContext.Provider',
    );
