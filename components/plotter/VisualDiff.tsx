    ...
    <div className="grid grid-cols-1 gap-3 font-sans">
      {hasOld && (
        <div className="p-3 bg-rose-950/20 border border-rose-500/20 rounded-xl relative overflow-hidden group">
          ...
          <div className="text-[8px] font-black text-rose-400 uppercase mb-2 tracking-widest pl-2">
            {t('plotter.sync.diff_old', uiLanguage)}
          </div>
      ...
      <div
        className={`p-3 bg-emerald-950/20 border border-emerald-500/20 rounded-xl relative overflow-hidden ${!hasOld ? 'border-dashed' : ''}`}
      >
        <div className="absolute top-0 left-0 w-1 h-full bg-emerald-500/40" />
        <div className="text-[8px] font-black text-emerald-400 uppercase mb-2 tracking-widest pl-2">
          {t('plotter.sync.diff_new', uiLanguage)}
        </div>
        <div className="pl-2">
