...
import { Loader2, Image as ImageIcon, Sparkles, Target, Activity, Lock, ChevronDown, ChevronUp, Package, Brain, MapPin, Heart } from 'lucide-react';
...
export const CharacterCard = React.memo(({ character: c, onGeneratePortrait, isGenerating }: CharacterCardProps) => {
  ...
  return (
    <div className={`glass-bright rounded-[2rem] md:rounded-[2.5rem] overflow-hidden border border-white/5 flex flex-col h-full hover:border-orange-500/20 transition-all shadow-xl group ${isExpanded ? 'ring-2 ring-orange-500/30' : ''}`}>
