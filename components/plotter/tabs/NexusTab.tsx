        ...
        <div className="lg:col-span-4 flex flex-col gap-4 min-h-0">
          ...
          <div className="flex-1 overflow-y-auto custom-scrollbar space-y-2 pr-2">
            ...
            {branches.map((branch) => (
              ...
              >
                <div className="text-[8px] font-mono text-stone-500 mb-1">
                  {new Date(branch.timestamp).toLocaleDateString()}
                </div>
                <div className="text-[11px] font-bold text-stone-200 line-clamp-2 leading-relaxed">
                  "{branch.hypothesis}"
                </div>
