...
export const syncOperationSchema = {
  type: Type.OBJECT,
  properties: {
    op: { type: Type.STRING, description: "操作種別: add, update, delete, set, merge" },
    ...
    field: { type: Type.STRING, description: "更新フィールド (metadata, status, involvedCharacterIds等)" },
    value: { 
      type: Type.OBJECT, 
      description: "追加・更新するデータ構造。パスに応じて柔軟に変更可能。"
    },
